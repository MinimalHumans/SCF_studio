...
Usage:
    ...
    (default output: ../scf-core/registry/registry.json)
...
from migrations import SCHEMA_VERSION, _UUID_EXTRA_TABLES  # noqa: E402
...
def build() -> dict:
    return {
        "$comment": "GENERATED FILE — do not hand-edit. Source of truth: "
                    "scf-editor/entity_registry.py. Regenerate with "
        ...
        "uuidExtraTables": list(_UUID_EXTRA_TABLES),
...
def main() -> int:
    ...
    out_path = (Path(args[0]) if args
                else PROJECT_ROOT.parent / "scf-core" / "registry"
                / "registry.json")
    payload = build()
