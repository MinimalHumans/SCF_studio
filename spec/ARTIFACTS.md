...
|---|---|---|
| `spec/scf-spec.md` | `ab8e0767e51fd3f2…` | The specification. Everything normative about the format is here or cited from here. |
...
| `spec/CHANGELOG.md` | `a082c47a947c6b42…` | The specification changelog. Spec §11.5. |
