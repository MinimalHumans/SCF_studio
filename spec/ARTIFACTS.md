...
|---|---|---|
| `spec/scf-spec.md` | `4427da4481aff2d3…` | The specification. Everything normative about the format is here or cited from here. |
...
| `spec/CHANGELOG.md` | `e0d80255393577e7…` | The specification changelog. Spec §11.5. |
