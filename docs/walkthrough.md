...
**Read that finding, because it is the format's whole disposition in one
line.** A scene has been outlined and not yet written. That is not an
error, does not stop anything, and is reported anyway — with what it
means for the answer and what is unaffected.
