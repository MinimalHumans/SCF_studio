...
| `docs/` | `glossary.md` and `faq.md` (start here if the format is new to you), `conventions.md` (the design record — why the format is the way it is), `schema-changelog.md`, `story-structure-design-record.md`, `release-checklist.md` (what stands between here and 1.0). |
